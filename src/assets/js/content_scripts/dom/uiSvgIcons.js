 ...
 * @return {String}
 */
export function getGearIcon(config) {
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${config.width}px" height="${config.height}px" viewBox="0 0 24 24" fill="currentColor">
